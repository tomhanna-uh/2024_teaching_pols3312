...
- Answers to questions from last class 
- A review of what constitutes a scientific question


## Questions from Last Class and related comments

- Self-report surveys
- Human rights violations measurement
- General comments on measurement
- Normative judgments about blame for human rights violations
...
- There was a normative comment about blame for human rights violations belonging to colonizers
- If this was a response to the paper, it was a strawman argument
- The paper makes no statement about blame for human rights violations
- The paper makes no statement about blame for anything
- Blame is a moral, philosophical question. 
- Immediate cause does not equate to blame, as it does not rule out prior causes or mitigating circumstances.
